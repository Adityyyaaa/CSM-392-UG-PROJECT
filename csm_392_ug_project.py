...
Original file is located at
    https://colab.research.google.com/drive/1De4oRO29GVFoS8B1qxDhAWXU1dv3R6aS
"""
...
def load_yolo():
    ...
    net = cv2.dnn.readNet("C:\\Users\\aditya\\Jupyter\\Object Detection Using YOLOv3\\yolov3.weights", "C:\\Users\\aditya\\Jupyter\\Object Detection Using YOLOv3\\yolov3.cfg")

    # Creating a list of class names
    classes = []
    with open("C:\\Users\\aditya\\Jupyter\\Object Detection Using YOLOv3\\coco.names", "r") as f:
...
def start_video(video_path = "C:\\Users\\aditya\\Videos\\Captures\\wood 3 killing platinum 3.mp4"):
	model, classes, colors, output_layers = load_yolo()
